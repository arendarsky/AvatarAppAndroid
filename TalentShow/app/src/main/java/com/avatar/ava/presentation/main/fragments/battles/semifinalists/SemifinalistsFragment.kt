...
import com.avatar.ava.presentation.main.fragments.battles.BattlesAdapter
...
import kotlinx.android.synthetic.main.fragment_semifinalists.*
import toothpick.Toothpick
import javax.inject.Inject

class SemifinalistsFragment : MvpAppCompatFragment(), SemifinalistsView {

    @Inject
    lateinit var appContext: Context

    @InjectPresenter
    lateinit var battlesPresenter: SemifinalistsPresenter

    private lateinit var battlesAdapter: BattlesAdapter

    @ProvidePresenter
    fun getPresenter(): SemifinalistsPresenter {
        return Toothpick.openScope(App::class.java).getInstance(SemifinalistsPresenter::class.java)
    }
    ...
    override fun onCreateView(
            ...
            : View? {
        return inflater.inflate(R.layout.fragment_semifinalists, container, false)
    }
